use crate::entity_profile::{
    ...
    CountryProfile, DiplomacySection, DiplomaticSummary, EconomicIndicator, EntityHeader,
    EntityKind, EntityRef, HeadlineStats, IndicatorFormat, LocationHeader, LocationProfile,
