...
pub fn achievements() -> Vec<Achievement> {
    vec![
        ...
        Achievement {
            ...
            description: String::from(
                "Form the Netherlands as a minor nation starting with Dutch culture. Nice",
            ),
            difficulty: Difficulty::Medium,
            // }, Achievement {
            //     id: 84,
        ...
        Achievement {
            ...
            description: String::from(
                "Starting as a Tartar steppe nomad, form the golden horde before 1500",
            ),
            difficulty: Difficulty::Medium,
        },
        Achievement {
        ...
        Achievement {
            ...
            description: String::from(
                "As the Knights, own the Caribbean and every island in the Mediterranean. (Colonies are NOT allowed)",
            ),
            difficulty: Difficulty::Hard,
        },
        Achievement {
        ...
        Achievement {
            ...
            description: String::from(
                "Have the most development while owning no province with terrain other than desert or coastal desert",
            ),
            difficulty: Difficulty::Hard,
        },
        Achievement {
        ...
        Achievement {
            ...
            description: String::from(
                "Custom achievement where one needs to form the Roman Empire",
            ),
            difficulty: Difficulty::Medium,
        },
    ]
