...
//
// Ported from serde_path_to_error v0.1.20 and adapted to use bumpalo arena allocation.
...
// Re-export the main types that will be part of the public API
use core::cell::Cell;
...
pub(crate) enum Chain<'a> {
    ...
    #[allow(dead_code)] // Used when deserializing struct fields via derive macro
    Struct {
        parent: &'a Chain<'a>,
        key: &'static str,
    },
