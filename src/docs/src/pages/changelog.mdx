...
- 🐛 - Fix naval morale tooltip typo

## 2025-08-28

- 🐛 - Fix detection of the three mountains achievement

## 2025-07-31

- 🐛 - Fix account typo in navigation header

## 2025-07-11

- 🐛 - Fix swapping between map modes where timelapse support is toggled

## 2025-07-04

- 🐛 - Fix EU4 annual ledger graphs broken by tailwind v4 upgrade

## 2025-06-29

- 🐛 - Fix issues loading Ck3, Vic3, and Imperator saves
...
- 🐛 - Fix incorrect dev cost modifier for mountain provinces
- 🐛 - Fix omission of exploit step in dev push institution

## 2025-04-27

- 🐛 - Show 1.35 ideas of Court, Mercenary, and Infrastructure in Idea Groups Picked chart
- 🐛 - Include a data table pagination size picker that is persisted across sessions.

## 2025-04-20

- 🐛 - Fix Idea Groups Picked chart only showing 1.31 ideas
- 🐛 - Use a monospace font for timelapse date to avoid layout shift

## 2025-04-18

- ✨ - Dynamic default timelapse speed based on length of save 

## 2025-04-10

- 🐛 - Player calculation updated to look at "was_player" countries that have at least one city
- 🐛 - Remove morale speculation when armies are at minimum morale
- 🐛 - Fix crash on history page when the country had no history
- 🐛 - Fix logic error for best admiral calculation in health heatmap causing incorrect colors

## 2025-04-03

- ✨ - Add estimated land / naval morale to health heatmap and country details
- ✨ - Add drag and drop column reordering to health heatmap 
- 🐛 - Improved Chinese support

## 2025-03-28

- ✨ - Add achievement: the Third Way

## 2025-03-22

- ✨ - Country budget page update
- ✨ - Country institution page update
- 🐛 - Fix dev push institution recommending exploiting development at 3

## 2025-03-14

- ✨ - Update to support HOI4 1.16.0 saves
- ✨ - Update to support CK3 1.14.3 saves
- 🐛 - Fix styling of the register page

## 2025-03-01

- ✨ - Performance improvement for parsing and melting saves
- ✨ - Improve text on EU4 saves that use the Chinese language mods. Community suggestions on how to improve this would be greatly appreciated!

## 2024-12-03

- 🐛 - Non-functional Skanderbeg support has been removed

## 2024-11-18

- 🐛 - "Include subjects" now includes subjects of subjects
- 🐛 - Fix error about "pdxScreenshot" when loading more than one save

## 2024-11-14

- ✨ - Save previews now present on share links and loading screens

## 2024-10-25

- 🐛 - Fix CK3 1.13 ironman support

## 2024-10-04

- ✨ - Refreshed country budget screen
- ✨ - Update CK3 ironman support to 1.13
- 🐛 - Fix active war tooltips displayed offscreen
- 🐛 - Fix geographical development tree unreadable text in dark mode

## 2024-09-25

- 🐛 - Fix faulty reinitialization of map on new save load

## 2024-09-24

- ✨ - Screenshot positioned on timelapse bar and includes date in screenshot
- ✨ - Timelapse recording now shows view options before recording
- ✨ - Faster and smoother initialization of map
