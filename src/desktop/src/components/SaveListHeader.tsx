    ...
    <header className="relative overflow-hidden border-b border-slate-700/60 bg-slate-900/45 backdrop-blur-xl">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-8">
        <div className="flex items-center gap-4">
          ...
          {/* Enhanced typography */}
          <div>
            <h1 className="mb-1 text-3xl font-bold tracking-tight text-white">PDX Tools</h1>
            <p className="text-sm font-medium text-amber-200/60">Explore your Paradox game saves</p>
          </div>
        </div>
      </div>
    </header>
