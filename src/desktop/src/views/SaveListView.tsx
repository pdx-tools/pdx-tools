...
import { detectEu5GamePath, getDefaultSaveDirectory, scanSaveDirectory } from "../lib/tauri";
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <SaveListGrid saves={filteredSaves} isLoading={isScanning} onOpenSave={handleOpenSave} />
