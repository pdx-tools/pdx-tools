...
pub struct CountryDetails {
    ...
    pub income: CountryIncomeLedger,
    pub expenses: CountryExpenseLedger,
    pub ytd_income: CountryIncomeLedger,
    pub ytd_expenses: CountryExpenseLedger,
    pub last_year_income: CountryIncomeLedger,
    pub last_year_expenses: CountryExpenseLedger,
