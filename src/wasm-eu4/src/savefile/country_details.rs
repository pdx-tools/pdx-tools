...
impl SaveFileImpl {
    ...
    pub fn get_country_details(&self, save_country: SaveCountry) -> CountryDetails {
        ...
        CountryDetails {
            ...
            ytd_income: self.query.country_ytd_income_breakdown(country),
            ytd_expenses: self.query.country_ytd_expense_breakdown(country),
            last_year_income: self.query.country_last_year_income_breakdown(country),
            last_year_expenses: self.query.country_last_year_expense_breakdown(country),
