...
// https://raw.githubusercontent.com/ant-design/ant-design-icons/master/packages/icons-svg/svg/outlined/area-chart.svg
export const ChartAreaIcon = React.forwardRef<SVGSVGElement, React.SVGAttributes<SVGElement>>(
  function ChartAreaIcon(props, forwardedRef) {
    return (
      <svg
