...
const badge = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        green:
          "bg-green-100 border border-solid border-green-200 dark:bg-green-800 dark:border-green-700 dark:text-white",
        blue: "bg-sky-100 border border-solid border-sky-200 dark:bg-sky-800 dark:border-sky-700 dark:text-white",
        default:
